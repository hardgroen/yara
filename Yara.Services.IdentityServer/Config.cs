...
public static class Config
{
    ...
    public static IEnumerable<ApiScope> ApiScopes =>
        new ApiScope[]
        {
            new ApiScope("postings.fullaccess", new string[] { "name" }),
    ...
    public static IEnumerable<ApiResource> ApiResources =>
       new ApiResource[]
       {
                ...
                {
                    Scopes = { "spaclientbff.fullaccess", "postings.fullaccess" }
                }
       };
    ...
    public static IEnumerable<Client> Clients =>
        new Client[]
        {
            ...
            new Client
             ...
             new Client
                {
                    ClientName = "YARA BFF Swagger UI",
                    ClientId = "spaclientbff.swagger",
                    ClientSecrets = { new Secret("ce766e16-df99-411d-8d31-0f5bbc6b8eba".Sha256()) },
                    AllowedGrantTypes = GrantTypes.Code,
                    RequirePkce = true,
                    RequireClientSecret = false,
                    ...
                    AllowedScopes = { "openid", "profile", "spaclientbff.fullaccess", "postings.fullaccess" },
                    AlwaysSendClientClaims = true,
                    AlwaysIncludeUserClaimsInIdToken = true,
                    AllowOfflineAccess = true,
                    RefreshTokenUsage = TokenUsage.ReUse,
